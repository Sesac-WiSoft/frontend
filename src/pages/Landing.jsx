      ...
      <section className="landing__steps">
        ...
        <div className="steps-grid">
          {steps.map((step, index) => (
            <motion.div key={step.label} className="step-card" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: index * 0.1 }} viewport={{ once: true }}>
